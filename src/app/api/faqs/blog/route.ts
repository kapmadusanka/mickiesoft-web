...
export async function GET(request: Request) {
    try {
        ...
        // Read the json file from src/db/faqs/blog-faqs-list/{locale}.json
        const faqs = await readJson('faqs', 'blog-faqs-list', `${locale}.json`);
        ...
        console.error('Error reading blog FAQs:', error);
        return NextResponse.json({
            success: false,
